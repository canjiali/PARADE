...
export output_dir=/data-crystina/canjia/data/covid/training.data/num-segment-${num_segment}/round3
mkdir -p $output_dir 
...
python3 -u generate_data.py \
    ...
    --query_filename=/data-crystina/canjia/tool/anserini/src/main/resources/topics-and-qrels/topics.covid-round3.xml \
    --query_field=question \
    --corpus_filename=/data-crystina/canjia/data/covid/runs/anserini.covid-r3.fusion2.txt.docid_content.txt \
